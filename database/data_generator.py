...
class DataGenerator:
    ...
    def generate_all_data(self, shipper_count=10, courier_count=15, shipment_count=50):
        ...
        print("Generating shipper processes...")
    ...
    def print_sample_data(self):
        ...
        for shipper in shippers:
            print(
                f"  ID: {shipper.shipper_id}, Name: {shipper.name}, Email: {shipper.email}"
            )
        ...
        for courier in couriers:
            print(
                f"  ID: {courier.courier_id}, Name: {courier.name}, Status: {courier.status}, Phone: {courier.contact_number}"
            )
        ...
        for shipment in shipments:
            print(
                f"  ID: {shipment.shipment_id}, Status: {shipment.shipment_status}, ETA: {shipment.eta}"
            )
...
def main():
    ...
    try:
        ...
        data = generator.generate_all_data(
            shipper_count=20, courier_count=30, shipment_count=100
        )
